...
```
cat <<EOF >/var/www/projectLEMP/index.html
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <h1>Hello, This is our lemp site!</h1>
</body>
</html>
EOF
```
...
If you see following page, then your NGINX web server is now correctly working.

![Nginx-Working](./images/site-ss.png.png)
